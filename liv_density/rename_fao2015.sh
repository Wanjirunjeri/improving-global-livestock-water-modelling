...
input_dir="fao_density_2015"
output_dir="fao_density_renamed_2015"
mkdir -p $output_dir
...
for file in $input_dir/*.nc; do
    ...
    output_file="$output_dir/fao_${animal_name}_2015.nc"

    # Rename the variable from Band1 to population_density and save with the new name
    echo "Renaming variable and file: $basename -> fao_${animal_name}_2015.nc"
